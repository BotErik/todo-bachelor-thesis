...
<template>
  <div v-if="show" class="absolute top-0 left-0 right-0 bottom-0 w-full h-full bg-light-text bg-opacity-90 z-30 flex justify-center items-center">
    <div class="relative mx-[30px] h-[40%] w-full bg-light-panel dark:bg-dark-text rounded-[10px] flex flex-col justify-center p-[20px] gap-[20px] z-40">
      ...
      <div class="flex flex-col">
        <input @keyup="updateItemText" type="text" class="h-[45px] rounded-[10px] bg-light-background dark:bg-dark-panel px-[10px] text-[16px] font-medium text-light-text dark:text-dark-text placeholder:text-light-text-38 placeholder:dark:text-dark-text-60" placeholder="Titel des ToDos eintragen ...">
